...
const translations = {
    ja: {
        ...
        'scan-fallback-button': '代替入力',
        'scan-shortcut-button': 'Scan',
        'manual-shortcut-button': '一覧',
    ...
    en: {
        ...
        'pagination-limit-label': 'Per Page',
        ...
        'scan-fallback-button': 'Fallback Input',
        'scan-shortcut-button': 'Scan',
        'manual-shortcut-button': 'List',
